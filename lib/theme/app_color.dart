...
class AppColor {
  static ColorScheme colorScheme = ColorScheme.fromSeed(
      seedColor: const Color.fromARGB(255, 8, 237, 168),
  ...
  static const Color boxColor = Color(0xFF0E0B93);
  static const Color favoriteButtonColor = Color(0xFFFE4657);
...
class ConstantsColor {
  ...
  static const orangeColor = Color(0xfffcf1d5);
  static const lightorangeColor = Color(0xfffef9ef);
